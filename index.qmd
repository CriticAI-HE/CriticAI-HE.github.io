...
Start by joining the conversation in these channels: {{< fa brands github >}} <https://github.com/orgs/CriticAI-HE/discussions>, {{< fa solid comments >}} [[Matrix] Space](https://matrix.to/#/!HTlQauruCuGUrpjgNw:matrix.org?via=matrix.org).
